...
export default function MapLegend({ mapLayer }: Props) {
    const data = LEGEND_INFO[mapLayer];
    ...
    return (
        <div className="absolute flex flex-col gap-3 top-4 right-4 z-1000 w-96 rounded-xl border-accent/70 shadow-lg p-4 bg-background/50">
